...
inspired by xkcd. we can determine ideal city by looking at wintertemperature
...
service (KNMI, --- Royal Netherlands, Metereological Institute). 
The weatherservice has a nice interactive download page where you can specify
what you want.  There is also a REST api, but this works too.
...
This is all just helpfull information
...
plot like xkcd
I am basically just following the script of Mäelle here, because it is
so good!
